...
class BookmarkRepositoryImpl @Inject constructor(
    ...
    override suspend fun getWantBookmark(userId: Int, page: Int): MutableList<WantedArticleBookmark> {
        return api.getWantBookmarkResult(userId, page).wantedArticles.toMutableList()
    }

    override suspend fun getGiveBookmark(userId: Int, page: Int): MutableList<RentArticleBookmark> {
        return api.getGiveBookmarkResult(userId, page).rentArticles.toMutableList()
    }
