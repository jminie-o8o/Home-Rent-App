...
VALUES (1, true, true, true, true, false, false, false, false, true, true, false),
 ...
 (3, true, true, true, true, false, false, false, false, true, true, false),
 (4, true, true, true, true, false, false, false, false, true, true, false),
 (5, true, true, true, true, false, false, false, false, true, true, false),
 (6, true, true, true, true, false, false, false, false, true, true, false),
 (7, true, true, true, true, false, false, false, false, true, true, false),
 (8, true, true, true, true, false, false, false, false, true, true, false),
 (9, true, true, true, true, false, false, false, false, true, true, false),
 (10, true, true, true, true, false, false, false, false, true, true, false),
 (11, true, true, true, true, false, false, false, false, true, true, false),
 (12, true, true, true, true, false, false, false, false, true, true, false),
 (13, true, true, true, true, false, false, false, false, true, true, false),
 (14, true, true, true, true, false, false, false, false, true, true, false);
...
INSERT INTO  rent_article (rent_article_id, address, address_description, address_detail, available_from, content, contract_expires_at, contract_type, created_at, deposit,
                           ...
                           max_floor, modified_at, rent_fee, status, this_floor, title, view_count, user_id, house_facility_id, bookmark_count)
VALUES
    ('1', '서울특별시 성동구', '왕십리역 5분거리', '왕십리로 309', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:55:06.239433', 0,'ONEROOM',
     false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:55:06.239444', '500000', NULL, '2', '왕십리역 원룸(1000/50)', '0', 1, 1, 0),
('2', '서울특별시 성동구', '왕십리역 코앞', '고산자로 269', '2022-08-01', '초역세권 원룸 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:55:16.979353', 0, 'ONEROOM',
    false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:55:16.979359', '550000', NULL, '2', '왕십리역 초역세권 원룸(1000/55)', '0', '1', 2, 0),
('3', '서울특별시 성동구', '왕십리역 10분거리', '고산자로 284', '2022-08-01', '채광좋은 원룸입니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:55:48.911475', 0,  'ONEROOM', false, false, '110.1', '1010.1231', '100000', '수도, 가스 별도', '4', '2022-08-19 02:55:48.911481', '550000', NULL, '2', '성동구 원룸(500/55)', '0', '1', 3, 0),
('4', '서울특별시 성동구', '왕십리역 7분거리', '왕십리로 336', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:55:53.205136', 0,  'ONEROOM', false, false, '110.1', '1010.1231', '100000', '수도, 가스 별도', '4', '2022-08-19 02:55:53.205142', '600000', NULL, '2', '한양대 후문 원룸(1000/65)', '0', '1', 4, 0),
('5', '서울특별시 성동구', '초역세권 왕십리역 도보3분', '왕십리로20길 30', '2022-08-01', '초역세권 원룸 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:56:06.257018', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '100000', '수도, 가스 별도', '4', '2022-08-19 02:56:06.257024', '600000', NULL, '2', '왕십리 원룸(1000/60)', '0', '1', 5, 0),
('6', '서울특별시 성동구', '왕십리역 코앞', '왕십리로 340', '2022-08-01', '채광좋은 원룸입니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:56:10.736606', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '650000', NULL, '2', '성동구 원룸(1000/65)', '0', '1', 6, 0),
('7', '서울특별시 성동구', '왕십리역 코앞', '왕십리로 320', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:56:20.736606', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '650000', NULL, '2', '왕십리역 원룸(1000/65)', '0', '1', 7, 0),
('8', '서울특별시 성동구', '왕십리역 7분거리', '왕십리로 332', '2022-08-01', '초역세권 원룸 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:56:30.736606', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '550000', NULL, '2', '왕십리역 초역세권 원룸(1000/55)', '0', '1', 8, 0),
('9', '서울특별시 성동구', '왕십리역 바로앞', '무학봉28길 30', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:56:40.736606', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '450000', NULL, '2', '성동구 원룸(1000/45)', '0', '1', 9, 0),
('10', '서울특별시 성동구', '왕십리역 도보 4분거리', '왕십리로 241', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:56:50.736606', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '550000', NULL, '2', '한양대 원룸(1000/55)', '0', '1', 10, 0),
('11', '서울특별시 성동구', '왕십리역 앞', '왕십리로 322', '2022-08-01', '초역세권 원룸 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:57:10.736606', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '600000', NULL, '2', '왕십리 원룸(1000/60)', '0', '1', 11, 0),
('12', '서울특별시 성동구', '왕십리역 코앞', '왕십리로22길 22', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:57:20.736606', 0,  'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:56:10.736613', '650000', NULL, '2', '왕십리 원룸(1000/65)', '0', '1', 12, 0),
('13', '서울특별시 성동구', '왕십리역 5분거리', '왕십리로 309', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:57:36.239433', 0,  'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:55:06.239444', '500000', NULL, '2', '왕십리역 원룸(1000/50)', '0', '2', 13, 0),
('14', '서울특별시 성동구', '왕십리역 5분거리', '왕십리로 309', '2022-08-01', '사정이 있어서 계약기간 못 채우고 양도합니다.', '2023-02-02', 'MONTHLY', '2022-08-19 02:57:46.239433', 0, 'ONEROOM', false, false, '110.1', '1010.1231', '50000', '수도, 가스 별도', '4', '2022-08-19 02:55:06.239444', '500000', NULL, '2', '왕십리역 원룸(1000/50)', '0', '2', 14, 0);
